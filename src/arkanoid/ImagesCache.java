...
public class ImagesCache {
	...
	public static String IMAGEN_BOLA = "bola.gif";
	public static String IMAGEN_PLAYER = "nave.gif";
	public static String IMAGEN_LADRILLOVERDE = "ladrilloVerde.gif";
	public static String IMAGEN_LADRILLOMAGENTA = "ladrilloMagenta.gif";
